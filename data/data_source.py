...
SAD_EVENTS = [
    ...
    Event(['حزين'], '2018-3-1', '2018-4-30', ['السعودية']),
    Event(['رسبت'], '2018-3-1', '2018-4-30', ['مصر', 'السعودية']),
...
DATA_BASE_DIRECTORY = 'fetched_data/v4/'
PART_DATA_BASE_DIRECTORY = 'fetched_part_data/v4/'
